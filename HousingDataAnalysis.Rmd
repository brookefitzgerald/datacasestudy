...
data.frame("Forward Selected Variables" = names(train.onehot%>%select_if(function(col) sum(col,na.rm=T)>10)%>%select(-PoolQCNone))[summary(forward_subset)$which[5,]], 
...
tp1 = ggplot(data = as.data.frame(cbind("Sale Price" = cvTest1$SalePrice,"Predicted Sale Price" = Pred1)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title= paste("RMSE: ",rmse1))+theme_few()
tp2 = ggplot(data = as.data.frame(cbind("Sale Price" = cvTest2$SalePrice,"Predicted Sale Prie" = Pred2)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title= paste("RMSE: ",rmse2))+theme_few()
tp3 = ggplot(data = as.data.frame(cbind("Sale Price" = cvTest3$SalePrice,"Predicted Sale Price" = Pred3)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title= paste("RMSE: ",rmse3))+theme_few()
tp4 = ggplot(data = as.data.frame(cbind("Sale Price" = cvTest4$SalePrice,"Predicted Sale Price" = Pred4)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title=paste("RMSE: ", rmse4))+theme_few()
tp5 = ggplot(data = as.data.frame(cbind("Sale Price" = cvTest5$SalePrice,"Predicted Sale Price" = Pred5)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title=paste("RMSE: ",rmse5))+theme_few()
...
ggplot(data = as.data.frame(cbind("Sale Price" =test.full$SalePrice,"Predicted Sale Price" = predict.gbm)), aes(x = Target, y = Predicted)) + geom_point() + geom_abline(slope = 1, intercept = 0) + xlim(0,5e05) + ylim(0, 5e05) + labs(title= paste("RMSE: ",RMSE.gbm))+theme_few()
```
