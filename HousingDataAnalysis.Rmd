...
best_subset<-regsubsets(SalePrice~.,data = one_hot_encoded_cc,nvmax=5,method="forward")
names(one_hot_encoded_cc)[summary(best_subset)$which[1,]]
names(one_hot_encoded_cc)[summary(best_subset)$which[2,]]
names(one_hot_encoded_cc)[summary(best_subset)$which[3,]]
names(one_hot_encoded_cc)[summary(best_subset)$which[4,]]
names(one_hot_encoded_cc)[summary(best_subset)$which[5,]]
